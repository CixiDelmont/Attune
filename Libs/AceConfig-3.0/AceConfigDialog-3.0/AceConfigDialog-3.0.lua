	...
	if not BlizOptions[appName][key] then
		...
		if Settings and Settings.RegisterCanvasLayoutCategory then
			...
			if parent then
				...
				-- Keep the numeric category.ID generated by Settings. Overwriting it with a
				-- string name used to work with Settings.OpenToCategory, but modern clients
				-- (C_SettingsUtil.OpenSettingsPanel) require an integer category ID.
