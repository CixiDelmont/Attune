...
Lang["DelInactive_CONF"] = "Действительно удалить все неактивные?"
Lang["DelInactive_DONE"] = "Все неактивные удалены"
Lang["RAIDS"] = "Рейды"
Lang["KEYS"] = "Ключи"
Lang["MISC"] = "Разное"
Lang["HEROICS"] = "Героизм"
...
Lang["Q1_11009"] = "Огрские небесаn"			-- https://www.thegeekcrusade-serveur.com/db/?quest=11009
...
Lang["N2_22497"] = "Вьеру находится в той же комнате, что и А'дал, но он синий. Он на полу."
