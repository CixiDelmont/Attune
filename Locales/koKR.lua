...
Lang["Splash"] = "v##VERSION## by Cixi Delmont / Gaya Greyhoof @ WoW:Forever. /attune 입력"
Lang["Survey"] = "조회"
Lang["Guild"] = "길드"
Lang["Party"] = "파티"
Lang["Raid"] = "공격대"
...
-- Synced from enUS (missing keys — English fallback until translated)
